...
public interface CategoryUserPermissionDAO {
	...
	public int removeCategoryUserPermission(CategoryUserPermission permission);
	
	public int deleteCategoryUserPermission(CategoryUserPermission permission);
	
	public boolean isCategoryUserPermissionExists(CategoryUserPermission permission);
	
	public boolean isCategoryUserPermissionUpdateable(CategoryUserPermission permission);
	
	public boolean isCategoryUserPermissionLocked(CategoryUserPermission permission);
	
	public boolean isCategoryUserPermissionRemoveable(CategoryUserPermission permission);
	
	public boolean isCategoryUserPermissionDeleteable(CategoryUserPermission permission);
	
	public CategoryUserPermission queryCategoryUserPermission(Long id);
	
	public List<CategoryUserPermission> queryCategoryUserPermissions(QueryBase query);
