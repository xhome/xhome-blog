...
public interface CategoryRolePermissionDAO {
	...
	public int removeCategoryRolePermission(CategoryRolePermission permission);
	
	public int deleteCategoryRolePermission(CategoryRolePermission permission);
	
	public boolean isCategoryRolePermissionExists(CategoryRolePermission permission);
	
	public boolean isCategoryRolePermissionUpdateable(CategoryRolePermission permission);
	
	public boolean isCategoryRolePermissionLocked(CategoryRolePermission permission);
	
	public boolean isCategoryRolePermissionRemoveable(CategoryRolePermission permission);
	
	public boolean isCategoryRolePermissionDeleteable(CategoryRolePermission permission);
	
	public CategoryRolePermission queryCategoryRolePermission(Long id);
	
	public List<CategoryRolePermission> queryCategoryRolePermissions(QueryBase query);
