...
public interface ArticleUserPermissionDAO {
	...
	public boolean isArticleUserPermissionExists(
			ArticleUserPermission permission);

	public boolean isArticleUserPermissionUpdateable(
			ArticleUserPermission permission);

	public boolean isArticleUserPermissionLocked(
			ArticleUserPermission permission);

	public boolean isArticleUserPermissionDeleteable(
			ArticleUserPermission permission);

	public ArticleUserPermission queryArticleUserPermission(Long id);

	public List<ArticleUserPermission> queryArticleUserPermissions(
			QueryBase query);
