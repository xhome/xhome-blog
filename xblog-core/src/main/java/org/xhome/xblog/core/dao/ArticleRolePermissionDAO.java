...
public interface ArticleRolePermissionDAO {
	...
	public boolean isArticleRolePermissionExists(
			ArticleRolePermission permission);

	public boolean isArticleRolePermissionUpdateable(
			ArticleRolePermission permission);

	public boolean isArticleRolePermissionLocked(
			ArticleRolePermission permission);

	public boolean isArticleRolePermissionDeleteable(
			ArticleRolePermission permission);

	public ArticleRolePermission queryArticleRolePermission(Long id);

	public List<ArticleRolePermission> queryArticleRolePermissions(
			QueryBase query);
