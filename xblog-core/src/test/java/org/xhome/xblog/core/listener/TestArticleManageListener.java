...
public class TestArticleManageListener implements ArticleManageListener {
    ...
    @Override
    public boolean beforeArticleManage(User oper, short action,
                    Article article, Object... args) {
        logger.debug("TEST BEFORE ARTICLE MANAGE LISTENER {} {} {}",
                        oper.getName(), action,
    ...
    public void afterArticleManage(User oper, short action, short result,
                    Article article, Object... args) {
        logger.debug("TEST AFTER ARTICLE MANAGE LISTENER {} {} {}",
                        oper.getName(), action,
                        article != null ? article.getTitle() : "NULL");
    }
