...
public class ArticleUserPermissionServiceTest extends AbstractTest {
	...
	public ArticleUserPermissionServiceTest() {
		articleUserPermissionService = context
				.getBean(ArticleUserPermissionServiceImpl.class);
		oper.setId(101L);
		...
		((ArticleUserPermissionServiceImpl) articleUserPermissionService)
				.registerArticleUserPermissionManageListener(new TestArticleUserPermissionManageListener());
	}

	@Test
	public void testAddArticleUserPermission() {
		ArticleUserPermission articleUserPermission = new ArticleUserPermission(
				article, user, permission);
		articleUserPermission.setOwner(1L);
		articleUserPermission.setModifier(1L);
		articleUserPermissionService.addArticleUserPermission(oper,
				articleUserPermission);
	}

	@Test
	public void testGetArticleUserPermission() {
		ArticleUserPermission articleUserPermission = articleUserPermissionService
				.getArticleUserPermission(oper, id);
	...
	public void testCountArticleUserPermissions() {
		...
		logger.info("{}", articleUserPermissionService
				.countArticleUserPermissions(oper, query));
	}
	...
	public void testGetArticleUserPermissions() {
		...
		List<ArticleUserPermission> articleUserPermissions = articleUserPermissionService
				.getArticleUserPermissions(oper, query);
	...
	public void testIsArticleUserPermissionUpdateable() {
		ArticleUserPermission articleUserPermission = articleUserPermissionService
				.getArticleUserPermission(oper, id);
		logger.info("{}", articleUserPermissionService
				.isArticleUserPermissionUpdateable(oper, articleUserPermission));
	}
	...
	public void testIsArticleUserPermissionDeleteable() {
		ArticleUserPermission articleUserPermission = articleUserPermissionService
				.getArticleUserPermission(oper, id);
		logger.info("{}", articleUserPermissionService
				.isArticleUserPermissionDeleteable(oper, articleUserPermission));
	}
	...
	public void testIsArticleUserPermissionLocked() {
		ArticleUserPermission articleUserPermission = articleUserPermissionService
				.getArticleUserPermission(oper, id);
		logger.info("{}", articleUserPermissionService
				.isArticleUserPermissionLocked(oper, articleUserPermission));
	}
	...
	public void testLockArticleUserPermission() {
		ArticleUserPermission articleUserPermission = articleUserPermissionService
				.getArticleUserPermission(oper, id);
		articleUserPermissionService.lockArticleUserPermission(oper,
				articleUserPermission);
	}
	...
	public void testUnlockArticleUserPermission() {
		ArticleUserPermission articleUserPermission = articleUserPermissionService
				.getArticleUserPermission(oper, id);
		articleUserPermissionService.unlockArticleUserPermission(oper,
				articleUserPermission);
	}
	...
	public void testUpdateArticleUserPermission() {
		...
		int r = articleUserPermissionService.updateArticleUserPermission(oper,
				articleUserPermission);
	...
	public void testIsArticleUserPermissionExists() {
		logger.info("{}", articleUserPermissionService
				.isArticleUserPermissionExists(oper, new ArticleUserPermission(
						article, user, permission)));
	}
	...
	public void testRemoveArticleUserPermission() {
		ArticleUserPermission articleUserPermission = articleUserPermissionService
				.getArticleUserPermission(oper, id);
		articleUserPermissionService.removeArticleUserPermission(oper,
				articleUserPermission);
		articleUserPermissionService.deleteArticleUserPermission(oper,
				articleUserPermission);
	}
