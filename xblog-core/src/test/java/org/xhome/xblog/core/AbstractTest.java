...
public abstract class AbstractTest {
    ...
    protected void printTag(Tag tag) {
        ...
        logger.debug("Id:" + tag.getId() + "\tName:" + tag.getName()
                        + "\tArticleTotal:" + tag.getArticleCount()
    ...
    protected void printCategory(Category category) {
        ...
        logger.debug("Id:" + category.getId() + "\tName:" + category.getName()
                        + "\tArticleTotal:" + category.getArticleCount()
    ...
    protected void printArticle(Article article) {
        logger.debug("Id:" + article.getId() + "\tTitle:" + article.getTitle()
                        ...
                        + "\tContent:" + article.getContent() + "\tVersion:"
                        + article.getVersion() + "\tStatus:"
                        + article.getStatus());
    ...
    protected void printArticleAttachment(ArticleAttachment articleAttachment) {
        if (articleAttachment == null) {
            return;
        }
        Article article = articleAttachment.getArticle();
        FileContent fileContent = articleAttachment.getFileContent();
        logger.debug("Id:" + articleAttachment.getId() + "\tArticleID: "
                        + article.getId() + "\tArticleTitle: "
                        + article.getTitle() + "\tFileContentID: "
                        + fileContent.getId() + "\tFileContentURL:"
                        + fileContent.getFullURL());
    }

    protected void printArticleAttachment(
                    List<ArticleAttachment> articleAttachmentes) {
