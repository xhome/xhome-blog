...
public class TagRolePermissionServiceTest extends AbstractTest {
	...
	public TagRolePermissionServiceTest() {
		tagRolePermissionService = context.getBean(TagRolePermissionServiceImpl.class);
		oper.setId(101L);
		tag = new Tag("TTTT");
		tag.setId(1L);
		role = new Role("Admin");
		...
		((TagRolePermissionServiceImpl)tagRolePermissionService).registerTagRolePermissionManageListener(new TestTagRolePermissionManageListener());
	}
	...
	public void testGetTagRolePermission() {
		TagRolePermission tagRolePermission = tagRolePermissionService.getTagRolePermission(oper, id);
		printTagRolePermission(tagRolePermission);
	}
	
	@Test
	public void testCountTagRolePermissions() {
		logger.info("{}", tagRolePermissionService.countTagRolePermissions(oper));
		
		QueryBase query = new QueryBase();
		query.addParameter("name", "test");
		logger.info("{}", tagRolePermissionService.countTagRolePermissions(oper, query));
	}
	
	@Test
	public void testGetTagRolePermissions() {
		List<TagRolePermission> tagRolePermissions = tagRolePermissionService.getTagRolePermissions(oper);
		printTagRolePermission(tagRolePermissions);
		
		QueryBase query = new QueryBase();
		query.addParameter("tag", "1");
		tagRolePermissions = tagRolePermissionService.getTagRolePermissions(oper, query);
		printTagRolePermission(tagRolePermissions);
	}
	...
	public void testIsTagRolePermissionUpdateable(){
		TagRolePermission tagRolePermission = tagRolePermissionService.getTagRolePermission(oper, id);
		logger.info("{}", tagRolePermissionService.isTagRolePermissionUpdateable(oper, tagRolePermission));
	}
	
	@Test
	public void testIsTagRolePermissionDeleteable(){
		TagRolePermission tagRolePermission = tagRolePermissionService.getTagRolePermission(oper, id);
		logger.info("{}", tagRolePermissionService.isTagRolePermissionDeleteable(oper, tagRolePermission));
	}
	
	@Test
	public void testIsTagRolePermissionLocked(){
		TagRolePermission tagRolePermission = tagRolePermissionService.getTagRolePermission(oper, id);
		logger.info("{}", tagRolePermissionService.isTagRolePermissionLocked(oper, tagRolePermission));
	}
	...
	public void testUnlockTagRolePermission(){
		TagRolePermission tagRolePermission = tagRolePermissionService.getTagRolePermission(oper, id);
		tagRolePermissionService.unlockTagRolePermission(oper, tagRolePermission);
	}
	...
	public void testUpdateTagRolePermission() {
		...
		int r = tagRolePermissionService.updateTagRolePermission(oper, tagRolePermission);
		logger.info("result:" + r);
	}
	
	@Test
	public void testIsTagRolePermissionExists() {
		logger.info("{}", tagRolePermissionService.isTagRolePermissionExists(oper, new TagRolePermission(tag, role, permission)));
	}
	
	@Test
	public void testRemoveTagRolePermission() {
		TagRolePermission tagRolePermission = tagRolePermissionService.getTagRolePermission(oper, id);
		tagRolePermissionService.removeTagRolePermission(oper, tagRolePermission);
		tagRolePermissionService.deleteTagRolePermission(oper, tagRolePermission);
	}
