...
public class TestCategoryManageListener implements CategoryManageListener {
	...
	@Override
	public boolean beforeCategoryManage(User oper, short action, Category category,
			Object... args) {
		logger.debug("TEST BEFORE CATEGORY MANAGE LISTENER {} {} {}", oper.getName(), action, category != null ? category.getName() : "NULL");
		return true;
	}
	...
	public void afterCategoryManage(User oper, short action, short result,
		...
		logger.debug("TEST AFTER CATEGORY MANAGE LISTENER {} {} {}", oper.getName(), action, category != null ? category.getName() : "NULL");
	}
