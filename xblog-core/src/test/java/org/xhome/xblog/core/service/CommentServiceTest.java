...
public class CommentServiceTest extends AbstractTest {
	...
	public CommentServiceTest() {
		...
		((CommentServiceImpl)commentService).registerCommentManageListener(new TestCommentManageListener());
	}
...
//		comment.setTarget(target);
	...
	public void testCountComments() {
		logger.info("{}", commentService.countComments(oper));
	...
	public void testGetComments() {
		List<Comment> comments = commentService.getComments(oper);
		printComment(comments);
		
		QueryBase query = new QueryBase();
		query.addParameter("name", "test");
		comments = commentService.getComments(oper, query);
		printComment(comments);
	}
