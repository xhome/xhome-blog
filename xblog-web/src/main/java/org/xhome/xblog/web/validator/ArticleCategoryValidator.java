...
public class ArticleCategoryValidator extends Validator {
	...
	public ArticleCategoryValidator() {
		...
		categoryNameValidator = validatorMapping.getValidatorByName(TagNameValidator.class.getName());
	}
	...
	public boolean validate(Object target, Errors errors) {
		...
		if (category == null) {
			errors.rejectValue(FIELD_CATEGORY, CODE_CATEGORY_EMPTY, validationConfig.getConfig(BlogValidatorConfig.ARTICLE_CATEGORY_EMPTY_MESSAGE));
			return false;
		}
