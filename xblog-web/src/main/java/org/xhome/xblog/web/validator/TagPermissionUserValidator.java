 ...
 * @description 
 */
public class TagPermissionUserValidator extends Validator {
	...
	public TagPermissionUserValidator() {
	...
	public boolean validate(Object target, Errors errors) {
		TagUserPermission permission = (TagUserPermission) target;
		User user = permission == null ? null : permission.getUser();
		if (user == null) {
			errors.rejectValue(FIELD_USER, CODE_USER_EMPTY, validationConfig.getConfig(BlogValidatorConfig.TAG_PERMISSION_USER_EMPTY_MESSAGE));
			return false;
		}
