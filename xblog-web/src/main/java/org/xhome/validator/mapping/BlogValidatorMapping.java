...
import org.xhome.xblog.web.action.MessageAction;
...
import org.xhome.xblog.web.validator.MessageContentValidator;
import org.xhome.xblog.web.validator.MessageReplyValidator;
import org.xhome.xblog.web.validator.MessageUserEmailValidator;
import org.xhome.xblog.web.validator.MessageUserNameValidator;
import org.xhome.xblog.web.validator.MessageUserWebsiteValidator;
...
public class BlogValidatorMapping implements Mapping {
    ...
    public Map<String, String> validatorMappings() {
        ...
        String articleTitleValidator = ArticleTitleValidator.class.getName(), articleDetailValidator = ArticleDetailValidator.class
                        ...
                        + articleCategoryValidator + "," + articleTagsValidator, articleIdTitleValidator = idValidator
        ...
        String commentContentValidator = CommentContentValidator.class
                        ...
                        + ","
                        + commentTargetValidator, commentAVersionValidator = idValidator
                        + ","
                        + commentArticleValidator
                        + ","
                        + versionValidator;
        ...
        String categoryPRoleValidator = CategoryPermissionRoleValidator.class
                        ...
                        + "," + versionValidator;
        mappings.put(CategoryRolePermissionAction.RM_CATEGORY_ROLE_PERMISSION_ADD,
                        categoryPCRValidator);
        mappings.put(CategoryRolePermissionAction.RM_CATEGORY_ROLE_PERMISSION_UPDATE,
                        baseValidator + "," + categoryPCRValidator);
        mappings.put(CategoryRolePermissionAction.RM_CATEGORY_ROLE_PERMISSION_LOCK,
                        categoryPCRVersionValidator);
        mappings.put(CategoryRolePermissionAction.RM_CATEGORY_ROLE_PERMISSION_UNLOCK,
                        categoryPCRVersionValidator);
        mappings.put(CategoryRolePermissionAction.RM_CATEGORY_ROLE_PERMISSION_DELETE,
                        categoryPCRVersionValidator);
        mappings.put(CategoryRolePermissionAction.RM_CATEGORY_ROLE_PERMISSION_EXISTS,
                        categoryPCRValidator);
        mappings.put(CategoryRolePermissionAction.RM_CATEGORY_ROLE_PERMISSION_UPDATEABLE,
                        categoryPCRValidator);
        mappings.put(CategoryRolePermissionAction.RM_CATEGORY_ROLE_PERMISSION_LOCKED,
                        categoryPCRValidator);
        mappings.put(CategoryRolePermissionAction.RM_CATEGORY_ROLE_PERMISSION_DELETEABLE,
                        categoryPCRValidator);
        ...
        String categoryPUserValidator = CategoryPermissionUserValidator.class
                        ...
                        + "," + versionValidator;
        mappings.put(CategoryUserPermissionAction.RM_CATEGORY_USER_PERMISSION_ADD,
                        categoryPCUValidator);
        mappings.put(CategoryUserPermissionAction.RM_CATEGORY_USER_PERMISSION_UPDATE,
                        baseValidator + "," + categoryPCUValidator);
        mappings.put(CategoryUserPermissionAction.RM_CATEGORY_USER_PERMISSION_LOCK,
                        categoryPCUVersionValidator);
        mappings.put(CategoryUserPermissionAction.RM_CATEGORY_USER_PERMISSION_UNLOCK,
                        categoryPCUVersionValidator);
        mappings.put(CategoryUserPermissionAction.RM_CATEGORY_USER_PERMISSION_DELETE,
                        categoryPCUVersionValidator);
        mappings.put(CategoryUserPermissionAction.RM_CATEGORY_USER_PERMISSION_EXISTS,
                        categoryPCUValidator);
        mappings.put(CategoryUserPermissionAction.RM_CATEGORY_USER_PERMISSION_UPDATEABLE,
                        categoryPCUValidator);
        mappings.put(CategoryUserPermissionAction.RM_CATEGORY_USER_PERMISSION_LOCKED,
                        categoryPCUValidator);
        mappings.put(CategoryUserPermissionAction.RM_CATEGORY_USER_PERMISSION_DELETEABLE,
                        categoryPCUValidator);
        ...
        String articlePRoleValidator = ArticlePermissionRoleValidator.class
                        ...
                        + "," + versionValidator;
        mappings.put(ArticleRolePermissionAction.RM_ARTICLE_ROLE_PERMISSION_ADD,
                        articlePARValidator);
        mappings.put(ArticleRolePermissionAction.RM_ARTICLE_ROLE_PERMISSION_UPDATE,
                        baseValidator + "," + articlePARValidator);
        mappings.put(ArticleRolePermissionAction.RM_ARTICLE_ROLE_PERMISSION_LOCK,
                        articlePARVersionValidator);
        mappings.put(ArticleRolePermissionAction.RM_ARTICLE_ROLE_PERMISSION_UNLOCK,
                        articlePARVersionValidator);
        mappings.put(ArticleRolePermissionAction.RM_ARTICLE_ROLE_PERMISSION_DELETE,
                        articlePARVersionValidator);
        mappings.put(ArticleRolePermissionAction.RM_ARTICLE_ROLE_PERMISSION_EXISTS,
                        articlePARValidator);
        mappings.put(ArticleRolePermissionAction.RM_ARTICLE_ROLE_PERMISSION_UPDATEABLE,
                        articlePARValidator);
        mappings.put(ArticleRolePermissionAction.RM_ARTICLE_ROLE_PERMISSION_LOCKED,
                        articlePARValidator);
        mappings.put(ArticleRolePermissionAction.RM_ARTICLE_ROLE_PERMISSION_DELETEABLE,
                        articlePARValidator);
        ...
        String articlePUserValidator = ArticlePermissionUserValidator.class
                        ...
                        + "," + versionValidator;
        mappings.put(ArticleUserPermissionAction.RM_ARTICLE_USER_PERMISSION_ADD,
                        articlePAUValidator);
        mappings.put(ArticleUserPermissionAction.RM_ARTICLE_USER_PERMISSION_UPDATE,
                        baseValidator + "," + articlePAUValidator);
        mappings.put(ArticleUserPermissionAction.RM_ARTICLE_USER_PERMISSION_LOCK,
                        articlePAUVersionValidator);
        mappings.put(ArticleUserPermissionAction.RM_ARTICLE_USER_PERMISSION_UNLOCK,
                        articlePAUVersionValidator);
        mappings.put(ArticleUserPermissionAction.RM_ARTICLE_USER_PERMISSION_DELETE,
                        articlePAUVersionValidator);
        mappings.put(ArticleUserPermissionAction.RM_ARTICLE_USER_PERMISSION_EXISTS,
                        articlePAUValidator);
        mappings.put(ArticleUserPermissionAction.RM_ARTICLE_USER_PERMISSION_UPDATEABLE,
                        articlePAUValidator);
        mappings.put(ArticleUserPermissionAction.RM_ARTICLE_USER_PERMISSION_LOCKED,
                        articlePAUValidator);
        mappings.put(ArticleUserPermissionAction.RM_ARTICLE_USER_PERMISSION_DELETEABLE,
                        articlePAUValidator);

        String messageContentValidator = MessageContentValidator.class
                        .getName(), messageReplyValidator = MessageReplyValidator.class
                        .getName(), messageValidator = baseValidator + ","
                        + messageContentValidator;
        mappings.put(MessageAction.RM_MESSAGE_ADD, messageContentValidator
                        + "," + MessageUserNameValidator.class.getName() + ","
                        + MessageUserEmailValidator.class.getName() + ","
                        + MessageUserWebsiteValidator.class.getName());
        mappings.put(MessageAction.RM_MESSAGE_UPDATE, messageValidator + ","
                        + messageReplyValidator);
        mappings.put(MessageAction.RM_MESSAGE_LOCK, messageValidator);
        mappings.put(MessageAction.RM_MESSAGE_UNLOCK, messageValidator);
        mappings.put(MessageAction.RM_MESSAGE_DELETE, messageValidator);
        mappings.put(MessageAction.RM_MESSAGE_UPDATEABLE, messageValidator);
        mappings.put(MessageAction.RM_MESSAGE_LOCKED, messageValidator);
        mappings.put(MessageAction.RM_MESSAGE_DELETEABLE, messageValidator);
